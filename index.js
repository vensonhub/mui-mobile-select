(function () {
    ...
    var MSelect = function (option) {
        ...
        var tpl = '<div class="alloy-selector" id="' + id + '">\
                        ...
                        <div class="alloy-selector-wrap">\
                            <div class="alloy-selector-head jmu-border-1px border-bottom">\
                                <div id="alloy-selector-complete-button-1" class="alloy-selector-button button-left">取消</div>\
                                <div id="alloy-selector-complete-button-2" class="alloy-selector-button button-right">确定</div>\
                            </div>\
        ...
        // enter btn
        var completeBtn1 = this.parentNode.querySelector('#alloy-selector-complete-button-1');
        completeBtn1.addEventListener('touchend', function (e) {
            that.hide()
            e.stopPropagation();
            e.preventDefault();
        }, false);
        var completeBtn2 = this.parentNode.querySelector('#alloy-selector-complete-button-2');
        completeBtn2.addEventListener('touchend', function (e) {
    ...
    function getCss(level) {
        ...
        return '* {\
                ...
                .alloy-selector-button.button-left {\
                    float: left;\
                    text-align: left;\
                }\
                .alloy-selector-button.button-right {\
                    float: right;\
                    text-align: right;\
                }\
